...
var tite="";
	var DFW = {
		appId: "",
		TLImg: "http://h5.91yxq.com/games/duimutou/icon.png",
		url: "http://h5.91yxq.com/games/duimutou/",
		title: "堆木头，简单的不得了，好玩的停不下",
		desc: "玩法简单，但是玩的是技巧，反应，没有最高只有更高，来挑战下--关注91游戏圈游戏:91游戏圈"
	};
...
function updateShare(stscore) {
	imgUrl = 'http://h5.91yxq.com/games/duimutou/i/icon.png';
	lineLink = 'http://h5.91yxq.com/games/duimutou';
