...
resetGame();}});Game.$el.btnShare.bind(util.mousedown,function(a){if(Game.isOver){Game.$el.share.show();}return true;});Game.$el.btnMore.bind(util.mousedown,function(b){if(Game.isOver){var a=/micromessenger/.test(window.navigator.userAgent.toLowerCase())?"http://mp.weixin.qq.com/s?__biz=MzA5MTAxNjIwMA==&mid=406799981&idx=1&sn=cf3176eb1f36d1eaf88404b68d02f5a3#rd":"http://mp.weixin.qq.com/s?__biz=MzA5MTAxNjIwMA==&mid=406799981&idx=1&sn=cf3176eb1f36d1eaf88404b68d02f5a3#rd";
