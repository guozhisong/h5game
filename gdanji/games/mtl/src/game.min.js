		...
		function a() {
			function a(c) {
				b.invoke(c, {
					...
					document.location="http://h5.91yxq.com";
				})
			}
...
var y = y || {};
y.Lh = "";
y.domain = "http://h5.91yxq.com";
y.url = function() {
	return "http://h5.91yxq.com?u="+ Math.floor(Math.random()*10000000);
};
y.qj = "http://h5.91yxq.com/mtl";
y = y || {};
y.game = "game.html";
y.Rc = {
	$h: q("91游戏圈游戏—今日热门《摩天楼》，等你来战！"),
	title: function() {
...
y.c.qe = x.Layer.extend({
	...
	Zi: function() {
		var a = this.Th = cc.LabelTTF.create("91游戏圈游戏", "Arial", 12);
	...
	ctor: function() {
		...
		function(a) {
			...
			var c = new y.c.Uc("+关注", "ma_button_blue", function() {
				location.href = "http://h5.91yxq.com"
			}, this);
