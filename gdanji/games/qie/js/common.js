...
;~function(bt){
	...
	bt.URL = {
		root: "http://h5.91yxq.com"
		,getMoreGame: function(){
			// 点击更多
			bt.dc("more");
			
			return "http://h5.91yxq.com";
		}
		,getConcern: function(){
			return "http://mp.weixin.qq.com/s?__biz=MzA5MTAxNjIwMA==&mid=406799981&idx=1&sn=cf3176eb1f36d1eaf88404b68d02f5a3#rd";
		}
