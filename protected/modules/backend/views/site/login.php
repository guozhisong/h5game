...
<div class="loginbox">
    ...
    <div id="loginform">
        ...
        <p>
            ...
            <input name="AdminLoginForm[name]" id="AdminLoginForm_username" type="text"  class="easyui-validatebox inputbox" data-options="required:true" value="<?php if(isset($_POST['AdminLoginForm']['name'])){ echo $_POST['AdminLoginForm']['name'];} ?>"/>
        </p>
        <p>
