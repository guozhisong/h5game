...
<ul class="index_tab2 clearfix">
    <li <?php if ($type == '网游') echo ' class="hover"'; ?>><a href="/games/"><p class="p1">网游</p><em></em></a></li>
    <li <?php if ($type == '单机') echo ' class="hover"'; ?>><a href="/games/fldanji/"><p class="p3">单机</p><em></em></a></li>
</ul>
<!--列表-->
<!--游戏分类-->
