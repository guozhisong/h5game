...
<ul class="index_tab2 clearfix">
    <li  <?php if($type=='游戏新闻') echo 'class="hover"'; ?> ><a href="/games/<?php echo $gid; ?>/news/"><p class="p1">新闻</p><em></em></a></li>
    <li <?php if($type=='游戏攻略') echo 'class="hover"'; ?> ><a href="/games/<?php echo $gid; ?>/gl/"><p class="p3">攻略</p><em></em></a></li>
</ul>

<!--新闻列表-->
<div class="public clearfix" style="border-bottom:none;">
    <ul class="news_list" id="_list">
    <?php foreach ($gameNews as $news) { 
